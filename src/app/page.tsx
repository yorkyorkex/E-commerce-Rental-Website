  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <h1 className="text-3xl font-bold text-gray-900">租屋網站</h1>
      ...
      <section className="bg-primary-600 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-4xl font-bold mb-4">找到您的理想住所</h2>
            <p className="text-xl mb-8">搜尋全台優質租屋物件</p>
          ...
          <div className={`${showFilters ? 'w-3/4' : 'w-full'}`}>
            ...
            {!loading && properties.length === 0 && (
              <div className="text-center py-12">
                <p className="text-gray-500 text-lg">沒有找到符合條件的物件</p>
              </div>
            )}
          </div>
        </div>
      ...
      <footer className="bg-gray-800 text-white py-8 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p>&copy; 2025 租屋網站. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
